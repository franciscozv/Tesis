...
class ResponsibilityController {
  ...
  public CreateResponsibility: RequestHandler = async (
    req: Request,
    res: Response
  ) => {
  ...
  public deleteResponsibility: RequestHandler = async (
    req: Request,
    res: Response
  ) => {
  ...
  public updateResponsibility: RequestHandler = async (
    req: Request,
    res: Response
  ) => {
    const id = Number.parseInt(req.params.id as string, 10);
