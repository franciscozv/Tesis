...
export class ResponsibilityRepository {
	async createAsync(data: Prisma.ResponsibilityCreateInput): Promise<Responsibility> {
	...
	async updateByIdAsync(id: number, data: Prisma.ResponsibilityUpdateInput): Promise<Responsibility | null> {
