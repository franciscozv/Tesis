...
import { historialRolGrupoRouter } from '@/api/historialRolGrupo/historialRolGrupoRouter';
...
import { rolesActividadRouter } from '@/api/rolesActividad/rolesActividadRouter';
...
app.use('/api/historial-rol-grupo', historialRolGrupoRouter);
...
app.use('/api/roles-actividad', rolesActividadRouter);
