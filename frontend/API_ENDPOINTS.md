...
| `usuario` | Acceso estándar (permisos según reglas de negocio) |
...
| Usuario (líder) | `lider@iepsantajuana.cl` | `Lider123!` |

| Usuario (miembro) | `miembro1@test.cl` | `Miembro123!` |
...
> Al crear el miembro se crea automáticamente su cuenta de acceso.

> La contraseña inicial corresponde a los **4 primeros dígitos del RUT**.
...
| `email` | string | Sí | Email de contacto (se usa para la cuenta) |
...
| `rol` | string | Sí | `administrador` \| `usuario` |
...
### PUT `/api/miembros/:id/cuenta`



Actualizar email y/o rol de la cuenta de un miembro.
...
### PATCH `/api/miembros/:id/password`



Restablecer contrase??a de un miembro.
...
| `cantidad_comprometida` | number | Sí | Cantidad comprometida |
