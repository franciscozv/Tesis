			...
			return isEditing ? (
				<div style={{ display: "flex", gap: "0.5rem" }}>
					<Button
						variant="outlined"
						color="success"
						onClick={() => table.options.meta?.saveRow?.(responsibility.id)}
					>
						Guardar
					</Button>
					<Button
				...
				<div style={{ display: "flex", gap: "0.5rem" }}>
					<Button
						...
						color="primary"
						onClick={() =>
							table.options.meta?.setEditingRowId?.(responsibility.id)
						}
					>
						Editar
					</Button>
					<Button
						variant="outlined"
						color="error"
						onClick={() => onDelete(responsibility.id, responsibility.name)}
					>
						Eliminar
					</Button>
				</div>
